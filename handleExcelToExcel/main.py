...
if __name__ == '__main__':
    ...
    print("数据总条数:"+str(rows))
    print("每个线程写的条数:"+str(pos))
    ...
    # 加入线程组
    t.append(threading.Thread(target=column_classification, args=(1, pos)))
    for x in range(1,thread_num-1):
        t.append(threading.Thread(target=column_classification, args=(x*pos, (x+1)*pos)))
